 ...
 * @author Sweet.Cakee
 */
public class NotaaviaController implements Initializable {
    ...
    private void nota() {
        ...
        int totall = avia * guest;
        origin.setText(AviaController.origin2);
        destination.setText(AviaController.destination2);
        depart.setText(AviaController.depart2);
        guests.setText(AviaController.guests2);
